...
describe('PublicRoutinePreviewModal', () => {
  ...
  // l'historique complet. Test de non-régression à la place : même si
  // une routine porte encore une ancienne description en base (jamais
  // nettoyée rétroactivement), elle ne doit plus s'afficher ici.
  it('même avec une ancienne description en base, elle ne doit plus être affichée (retiré le 08/08, non-régression)', () => {
    const routineWithOldDescription = { ...mockRoutine, content: { ...mockRoutine.content, description: 'Ancienne description jamais nettoyée en base' } };
    render(
      <PublicRoutinePreviewModal theme={mockTheme} isOpen={true} onClose={() => {}} routine={routineWithOldDescription} onClone={() => {}} />
    );
