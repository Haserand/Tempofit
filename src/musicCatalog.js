...
const ARTIST_CATALOG = {
  ...
  'K-pop': ['BLACKPINK', 'BTS', 'TWICE', 'Girls\' Generation', 'EXO', 'NCT', 'Stray Kids', 'SEVENTEEN', 'ATEEZ', 'ENHYPEN', 'TXT', 'ITZY', 'aespa', 'NewJeans', 'IVE', 'LE SSERAFIM', '(G)I-DLE', 'Red Velvet', 'MAMAMOO', '2NE1', 'Big Bang', 'SHINee', 'Super Junior', 'Wonder Girls', 'Sistar', 'f(x)', 'INFINITE', 'Monsta X', 'GOT7', 'iKON', 'WINNER', 'Apink', 'Oh My Girl', 'Loona', 'TVXQ', 'Shinhwa', 'H.O.T.', 'Sechskies', 'Highlight', 'NU\'EST', 'VIXX', 'Block B', 'B.A.P', 'Teen Top', 'BTOB', 'ASTRO', 'The Boyz', 'Golden Child', 'ONF', 'Verivery', 'Cravity', 'P1Harmony', 'ZEROBASEONE', 'RIIZE', 'BOYNEXTDOOR', 'TREASURE', '&TEAM', 'KARD', 'Triple H', 'Girl\'s Day', '4minute', 'T-ara', 'KARA', 'Brown Eyed Girls', 'After School', 'Secret', 'Rainbow', 'EXID', 'WJSN', 'Weki Meki', 'fromis_9', 'GFRIEND', 'Dreamcatcher', 'STAYC', 'Kep1er', 'NMIXX', 'Billlie', 'Kiss of Life', 'tripleS', 'Everglow', 'Cignature', 'Purple Kiss', 'VIVIZ', 'Weeekly', 'H1-KEY', 'Cherry Bullet', 'Lightsum', 'Woo!ah!', 'IU', 'Taeyeon', 'Sunmi', 'HyunA', 'CL', 'Zico', 'G-Dragon', 'Jay Park', 'Psy', 'Rain', 'BoA', 'Younha', 'Heize', 'DEAN', 'Crush', 'Zion.T', 'Jessi', 'Lee Hi', 'Ailee', 'Chungha', 'Hwasa'],
