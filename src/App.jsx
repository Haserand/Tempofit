...
import { Activity, Clock, Music, Save, Play, List, Plus, Check, Settings, Trash2, Pause, Search, X, Footprints, Flame, Heart, SlidersHorizontal, ListPlus, Loader2, User, Star, AlertCircle, Zap, BookmarkPlus, Menu, RefreshCw, Share2, Image as ImageIcon, Info, Edit3, Copy, CheckCircle, Trophy, MapPin, Upload, ChevronRight, ChevronLeft, ChevronUp, ChevronDown, Target, History, MessageCircle, ExternalLink, GripVertical, MoreVertical } from 'lucide-react';
