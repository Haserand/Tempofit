 ...
 * isBpmChartUsingRealProfile et trackBpmBucketLabel, partagés avec
 * TrackList) — une seule résolution d'activité, pas 2 implémentations.
 *
...
export default function PlaylistCharts({
  ...
  playlistCadenceUnit, bpmChartActivityName, isBpmChartUsingRealProfile,
