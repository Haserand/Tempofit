...
// ⚠️ `fakeCloneCountForId` (fonction jetable "ambitieuse mais fausse")
// RETIRÉE le 02/08 — retour direct : "je veux que le compteur de clonage
// soit honnête, 0 par défaut". Remplacée par une vraie table
// `template_clone_counts` (supabase-schema.sql) + une RPC dédiée
