...
À partir du bloc 12 (01/09), voir `HISTORIQUE-2.md` — ce fichier-ci
dépassait le seuil de taille en l'accueillant (même règle : jamais
réorganiser les blocs déjà numérotés, seulement ajouter proprement à la
suite, désormais dans le fichier suivant).
